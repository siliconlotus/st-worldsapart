...
.wa-tool-narrow { transform: scaleX(0.85); transform-origin: center; margin: 0 -0.1em; }   /* the scale leaves the box its full width; the margin takes back what the glyph gave up */
