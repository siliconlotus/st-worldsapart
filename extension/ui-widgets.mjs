...
.wa-rail { flex: 0 0 auto; display: flex; flex-direction: column; gap: 6px; padding: 2px 0 0 13px; }
...
.wa-icon-fromline::after { content: ''; position: absolute; width: 1em; height: 0.13em; border-radius: 1px; background: currentColor; }
