 ...
 *
 * @param {(item: object) => number} [scoreOf] Predicted relevance, NaN when unscored; the weighted credit the layout sorts by
 * @param {(item: object) => number} cutoffOf The row's tier cutoff, NaN when the tier has no fit
 * @returns {{kept: object[], cut: object[]}}
 */
export function relevanceCut(results, { scoreOf = weightedCredit, cutoffOf }) {
    const kept = [], cut = [];
