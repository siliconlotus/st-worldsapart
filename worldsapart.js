...
async function rankOwnedScan(activated, args, skip) {
    ...
    let windowFor = null;
    {
        ...
        // Live keys, else the takeover's stash; every entry's keys are scored, vectorized included (docs/matching.md, *Stage 3 — Scoring*).
        ...
        for (const item of items) {
            ...
            // An entry reached at recursion pass d did not have the conversation name it (docs/matching.md, *Stage 3 — Scoring*).
