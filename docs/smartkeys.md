...
[^4]: Any quotation mark: ", “” (curly), «», „“,「」,『』,《》,〈〉. Does not include double-prime ″. Note that quotes can be escaped by quotes from other families: `"《月亮代表我的心》"`, `"«Non, je ne regrette rien»"`.