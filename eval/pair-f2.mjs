...
// without is the other half of the feature set; blind to it, this guard cannot refuse a keys-column contrast.
...
// Nearest grid row by recall, and the row's actual recall is printed: a 1% grid does not hit every target.
