// undeclared-check.mjs — names USED in a file but declared nowhere in it and not imported: the refactor residue `node --check` passes.
// No scope analysis: declarations are collected file-wide, so over-approximating keeps it free of false alarms. acorn resolves from ST's node_modules.
