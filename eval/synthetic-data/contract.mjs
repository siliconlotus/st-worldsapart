...
// the model sees it, so it is not part of the contract: hashing it moves both rubric hashes when a
// `description` line is edited and neither instruction block changed (G9).
//
