...
const kwP = makeKeywordScore(sceneParams({}));   // scoreVectorKeys off — the default
eq(kwP({ vectorized: true, key: ['villa'] }, 'meet me at the villa', 1.2), 0, 'the DEFAULT suppresses a vectorized entry\'s keys, as the live scan would');
