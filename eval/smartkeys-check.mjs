...
// --- proximity: `(…)~N` holds a group to a window — its things within N words of each other, in any order
{
    ...
    eq(c('? (fire -(drill practice))~2', 'a fire drill, no practice'), 0, 'a compound negation is read whole over the padded window, with no reach of its own');
    eq(c('? (fire -(drill practice))~2', 'a fire drill today and tomorrow and practice'), 1, '...and stands when part of it is past the pad');
